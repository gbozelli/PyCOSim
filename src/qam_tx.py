...
# Importando a função refatorada nos passos anteriores
from qam_modulation import qam_modulation
# from dac_nyquist import DAC_Nyquist # Ajuste para o nome correto do seu arquivo

def qam_tx(N_sync=128, sync_seed=0, N_MIMO=32, MIMO_i=0,
