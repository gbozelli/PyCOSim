...
def dgd_for_step(pmd_coefficient: float, step: float) -> float:
    """DGD do passo. O acumulo em raiz da distancia sai do passeio aleatorio das
    orientacoes, entao o modulo por passo escala com sqrt(step)."""
