...
# teste atenuação (exp-az)
# dispersão cromatica (pulsso gaussiano -> full wiidth half max com um deltal, esta no Agrawal )
# n linearees como testar? gerar imagens para testar (gama p l efectivo)
# pmd - formula agrawal com sigma entrada/saida, deve seguir a formula de agrawal para teste estatistico entrada saida, crescre com a raiz da distancia
# fase deve ter mesma forma q pulso (drfszr msxima e amp maxima) 
